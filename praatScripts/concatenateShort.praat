...
form concatenate
	...
	boolean UseSelectedFiles yes

	comment Otherwise, specify files names:
   	sentence baseFile1 inPhaseShort.wav
   	sentence baseFile2 inPhaseSoftShort.wav
   	sentence baseFile3 outOfPhaseShort.wav
   	sentence baseFile4
    sentence inputDirectory ../individualSounds
    ...
    sentence outputDirectory ../sequences/short
